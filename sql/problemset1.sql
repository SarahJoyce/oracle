--------------------------------------------------------
--  File created - Monday-September-14-2020   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index COURSE_COURSE_FK_1
--------------------------------------------------------

  CREATE INDEX "COURSE_COURSE_FK_1" ON "COURSE" ("PREREQUISITE") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index ENR_SECT_FK_1
--------------------------------------------------------

  CREATE INDEX "ENR_SECT_FK_1" ON "ENROLLMENT" ("SECTION_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SECTION_UK1" ON "SECTION" ("SECTION_NO", "COURSE_NO") 
  ;
--------------------------------------------------------
--  DDL for Index SECT_CRSE_FK_1
--------------------------------------------------------

  CREATE INDEX "SECT_CRSE_FK_1" ON "SECTION" ("COURSE_NO") 
  ;
--------------------------------------------------------
--  DDL for Index SECT_INST_FK_1
--------------------------------------------------------

  CREATE INDEX "SECT_INST_FK_1" ON "SECTION" ("INSTRUCTOR_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  USING INDEX  ENABLE;
  ALTER TABLE "SECTION" ADD CONSTRAINT "SECTION_UK1" UNIQUE ("SECTION_NO", "COURSE_NO")
  USING INDEX  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "STUDENT" MODIFY ("REGRISTRATION_DATE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "ENROLLMENT" ADD CONSTRAINT "ENROLLMENT_STU_FK" FOREIGN KEY ("STUDENT_ID")
	  REFERENCES "STUDENT" ("STUDENT_ID") ENABLE;
  ALTER TABLE "ENROLLMENT" ADD CONSTRAINT "ENROLLMENT_SECT_FK" FOREIGN KEY ("SECTION_ID")
